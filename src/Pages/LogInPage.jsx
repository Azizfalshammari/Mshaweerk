          ...
          <div className="w-full py-10 px-5 md:px-10">
            <div className="text-center mb-10">
              <h1 className="font-bold text-3xl text-[#9685CF]">
                مرحبًا بك مرة أخرى ,<br />
                قم بإدخال بياناتك لتسجييل الدخول
              </h1>
            </div>
            <div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  <button className="block w-full max-w-xs mx-auto bg-[#9685CF] hover:bg-[#FFA842] focus:bg-[#FFA842] text-white rounded-lg px-3 py-3 font-semibold">
                    تسجيل دخول
                  </button>
                  <p className="text-center p-3 text-black">
                    {" "}
                    لا تملك حساب ؟{" "}
                    <Link to="/signup">قم بإنشاء حساب الان!</Link>
                  </p>
                </div>
              </div>
            </div>
