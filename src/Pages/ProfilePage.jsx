...
function ProfilePage() {
  ...
  return (
    <div className='profile text-right  m-[auto]'>
      <div className='contentProfile'>
        <div className='flex justify-center w-[80vw] mr-56 mt-[17vh] max-sm:mr-2 max-sm:mt-[20px]'>
            ...
            <ul className='sidebar-menu'>
              ...
              <div className='box sidebar-item text-[16px] flex mb-[10px]'>
                ...
                <span className='ml-[10px] mt-[-5px] text-gray-800'>
                  <Link to='/'>
                <i className="hidden fa-solid fa-house ml-[20px] mt-[-10px]"></i>
                </Link>
              ...
              <div className='box sidebar-item text-[16px] flex mb-[10px]' onClick={handleShowScheduleClick}>
                ...
                <span className='ml-[10px] mt-[-40px] text-gray-800'>
                  <i className="fa-solid fa-table  mt-[-20px]"></i>
                </span>
              </div>
              {/* end */}
              <Link to='/scheduler'>
              <div className='box sidebar-item text-[16px] flex mb-[10px] ' >
                ...
                <span className='ml-[10px] mt-[-40px] text-gray-800'>
                  <i class="fa-solid fa-location-pin mt-[-20px]"></i>
                </span>
              </div>
              </Link>
              {/* end */}
          ...
          <div className="form w-[60%] ml-4 flex-grow">
            <div className="inputs bg-white p-8 shadow-xl rounded-[4px] h-full max-sm:mr-4">
              {showSchedule ? (
