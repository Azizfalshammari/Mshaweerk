...
//     // تحميل سكربت خرائط جوجل وت初始化 الخريطة
//     useEffect(() => {
...
//     // تهيئة خدمات التحقق التلقائي للعنوان
//     useEffect(() => {
...
//         if (updatedLocations[index].position.lat && updatedLocations[index].position.lng) {
//             const marker = new window.google.maps.Marker({
...
//                                     <h2 className="text-2xl font-semibold p-3 text-black">أدخل مواقع المهام والمواعيد النهائية</h2>
...
//                                     {taskList.length > 0 && (
//                                         <div className="mt-8">
//                                             <h3 className="text-2xl font-semibold text-black p-3">قائمة المهام</h3>
//                                             <table className="min-w-full bg-white rounded-lg shadow-md">
//                                                 <thead>
//                                                     <tr>
//                                                         <th className="py-2 px-4 border-b-2 border-[#9685CF] text-right text-lg font-bold text-[#9685CF]">العنوان</th>
//                                                         <th className="py-2 px-4 border-b-2 border-[#9685CF] text-right text-lg font-bold text-[#9685CF]">الموعد النهائي</th>
...
//                                                         <tr key={index}>
//                                                             <td className="py-2 px-4 border-b border-gray-200">{location.address || "عنوان غير محدد"}</td>
//                                                             <td className="py-2 px-4 border-b border-gray-200">{location.deadline || "غير محدد"}</td>
