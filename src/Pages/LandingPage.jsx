...
import img1 from '../assets/landing-phot.png';
      ...
      <div className="w-full max-w-7xl md:h-full px-4 md:px-0">
        <div className="flex flex-col md:h-full md:flex-row-reverse">
          ...
          <div className="md:w-1/2 flex flex-col justify-center text-center md:text-right">
           ...
           <Link to="/scheduler">
           <button className="mt-5 btn text-3xl font-bold bg-[#FFA842] text-white font-bold px-4 py-2 md:px-6 md:py-2 hover:bg-b transition duration-300 md:text-base max-sm:self-center">
              ابدأ الان
            </button>
           </Link>
