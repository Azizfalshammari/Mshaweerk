...
// //   {
// //     id: 1,
// //     text: "ادخل جميع الأماكن التي تحتاج لزيارتها خلال الأسبوع.",
// //   },
// //   {
// //     id: 2,
// //     text: "حدد الأوقات التي تكون فيها مشغولًا لتجنب جدولة أي مشوار خلالها.",
// //   },
// //   {
// //     id: 3,
// //     text: "سنقوم بتحليل جميع البيانات المدخلة (المشاوير، المسافات، الأوقات المشغولة) باستخدام خرائط قوقل لنقوم بإنشاء جدول زمني مثالي، يضمن أقل مسافة بين المشاوير وأفضل توقيت لكل منها.",
// //   },
// // ];
...
// //       if (currentStep < usageSteps.length) {
...
// //     //     </h1>
// //     //   </div>
// //     //   <div className="space-y-8 container relative flex justify-center">
...
// //     //           >
// //     //             <div className="absolute left-1/2 transform max-sm:w-full -translate-x-1/2 top-0">
// //     //               <span className="inlineBlock w-12 h-12 rounded-full bg-[#9685CF] flex items-center justify-center text-xl font-bold text-black">
// //     //                 {step.id}
// //     //               </span>
// //     //             </div>
// //     //             <br />
...
// //     //           >
// //     //             <p className="text-lg text-gray-700 mt-6">{step.text}</p>
// //     //           </motion.div>
// //     //         )}
// //     //         {index < usageSteps.length - 1 && currentStep >= index && (
// //     //           <motion.svg
// //     //             initial={{ opacity: 0 }}
// //     //             animate={{ opacity: 1 }}
// //     //             transition={{ duration: 50 }}
