      ...
      <div className="px-4  pt-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className=" flex justify-center gap-10 row-gap-6 mb-8 items-center sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className='pt-6 grid grid-rows-2 text-center'>
            <span className="text-base font-bold tracking-wide text-[#9685CF]">تواصل معنا</span>
            <div className="flex mt-2 gap-4">
              ...
              <a href="#" className="text-gray-700 hover:text-gray-900">
                <svg fill="#000000" height="32px" width="32px" viewBox="0 0 216 216">
              ...
              <a href="https://www.instagram.com/jdwlha" target='_blank' rel='noopener noreferrer' className="text-black transition-colors duration-300 hover:text-deep-purple-accent-400">
                <svg viewBox="0 0 30 30" fill="currentColor" width="32px" height="32px">
