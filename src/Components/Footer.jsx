    ...
    <div className=" w-[100%] h-[35vh]">
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            <div className=" lg:max-w-sm">
              <p className="text-sm black">
                يقدم موقعنا حلاً ذكياً لتنظيم مشاويرك باستخدام خرائط قوقل. من
                خلال إدخال المشاوير وتحديد الأوقات المشغولة، يقوم الموقع بجدولة
                مثالية تضمن أقل مسافة وأفضل توقيت لكل مشوار. يتميز الموقع بسهولة
                الاستخدام، ويوفر وقتك بتجنب الزحام وتحقيق أقصى كفاءة لجدولك.{" "}
              </p>
            </div>
          </div>
          <div className="space-y-2 text-sm">
            <p className="text-base font-bold tracking-wide text-[#9685CF]">
              للتواصل
            </p>
            <div className="flex">
          ...
          <div>
            <span className="text-base font-bold tracking-wide text-[#9685CF]">
            ...
            <div className="flex items-center mt-2 mr-14 gap-4 space-x-3">
              ...
              <a
                href="https://www.instagram.com/jdwlha"
                target="_blank"
