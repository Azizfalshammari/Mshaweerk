...
const Sidebar = ({ onMenuClick }) => {
  ...
  return (
    <div
      ...
      className="h-screen w-32 bg-white shadow-lg transition-transform duration-300 ease-in-out max-sm:w-[4rem]"
    >
      <div className="flex flex-col h-full py-4 ">
        ...
        <div className="flex items-center justify-center mb-8">
          <Link to="/">
            <img
              src={isPhone ? phoneLogo : logo}
              alt="brand"
              className={`${
                isPhone ? 'w-24 h-24' : 'w-20 h-20'
