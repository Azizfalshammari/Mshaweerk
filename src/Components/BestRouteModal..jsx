...
//                             destination: `${latLngs[latLngs.length - 1].lat},${latLngs[latLngs.length - 1].lng}`,
//                             waypoints: latLngs.slice(1, -1).map(coord => `${coord.lat},${coord.lng}`).join('|'),
...
//         return routes.sort((a, b) => a.route.legs[0].duration.value - b.route.legs[0].duration.value);
//     };
...
//                     <li key={index}>
//                         Day {route.day}, Hour {route.hour}: {route.route.legs[0].duration.text}
//                     </li>
//                 ))}
//             </ul>
//         </Modal>
