...
const LocationChooserModal = ({ isOpen, onClose, onSave }) => {
  ...
  return (
    ...
    >
      <div className="w-[50vw] max-w-lg max-sm:w-[90vw] h-[50vh] bg-white p-4 rounded-lg shadow-lg">
        <div id="modal-map" className="h-[30vh] w-full border rounded-lg"></div>
        <input
          type="text"
          value={address}
          readOnly
        ...
        <div className="flex justify-center space-x-2 mt-4">
          <button
            onClick={handleSave}
            className="bg-[#9685CF] hover:bg-[#6b4b9a] text-white font-bold py-1 px-4 rounded focus:outline-none focus:shadow-outline"
          >
            حفظ الموقع
          </button>
          <button
            onClick={onClose}
            className="bg-[#FFA842] hover:bg-[#e68a33] text-white font-bold py-1 px-4 rounded focus:outline-none focus:shadow-outline"
          >
            الغاء
          </button>
          // abdulaziz 
